...
var file_aggregatingapis_infostream_v1_infostream_proto_rawDesc = string([]byte{
...
var (
	...
	file_aggregatingapis_infostream_v1_infostream_proto_rawDescData []byte
)
...
func file_aggregatingapis_infostream_v1_infostream_proto_rawDescGZIP() []byte {
	file_aggregatingapis_infostream_v1_infostream_proto_rawDescOnce.Do(func() {
		file_aggregatingapis_infostream_v1_infostream_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_aggregatingapis_infostream_v1_infostream_proto_rawDesc), len(file_aggregatingapis_infostream_v1_infostream_proto_rawDesc)))
	})
...
var file_aggregatingapis_infostream_v1_infostream_proto_goTypes = []any{
...
func file_aggregatingapis_infostream_v1_infostream_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_aggregatingapis_infostream_v1_infostream_proto_rawDesc), len(file_aggregatingapis_infostream_v1_infostream_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
