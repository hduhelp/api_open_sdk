...
var file_gatewayapis_server_v1_manager_proto_rawDesc = string([]byte{
...
var (
	...
	file_gatewayapis_server_v1_manager_proto_rawDescData []byte
)
...
func file_gatewayapis_server_v1_manager_proto_rawDescGZIP() []byte {
	file_gatewayapis_server_v1_manager_proto_rawDescOnce.Do(func() {
		file_gatewayapis_server_v1_manager_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gatewayapis_server_v1_manager_proto_rawDesc), len(file_gatewayapis_server_v1_manager_proto_rawDesc)))
	})
...
var file_gatewayapis_server_v1_manager_proto_goTypes = []any{
...
func file_gatewayapis_server_v1_manager_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gatewayapis_server_v1_manager_proto_rawDesc), len(file_gatewayapis_server_v1_manager_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
