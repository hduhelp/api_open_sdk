...
var file_gatewayapis_server_v1_register_proto_rawDesc = string([]byte{
...
var (
	...
	file_gatewayapis_server_v1_register_proto_rawDescData []byte
)
...
func file_gatewayapis_server_v1_register_proto_rawDescGZIP() []byte {
	file_gatewayapis_server_v1_register_proto_rawDescOnce.Do(func() {
		file_gatewayapis_server_v1_register_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gatewayapis_server_v1_register_proto_rawDesc), len(file_gatewayapis_server_v1_register_proto_rawDesc)))
	})
...
func file_gatewayapis_server_v1_register_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gatewayapis_server_v1_register_proto_rawDesc), len(file_gatewayapis_server_v1_register_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
