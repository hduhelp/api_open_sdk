...
var file_consultingapis_faq_v1_faq_proto_rawDesc = string([]byte{
...
var (
	...
	file_consultingapis_faq_v1_faq_proto_rawDescData []byte
)

func file_consultingapis_faq_v1_faq_proto_rawDescGZIP() []byte {
	file_consultingapis_faq_v1_faq_proto_rawDescOnce.Do(func() {
		file_consultingapis_faq_v1_faq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_consultingapis_faq_v1_faq_proto_rawDesc), len(file_consultingapis_faq_v1_faq_proto_rawDesc)))
	})
...
var file_consultingapis_faq_v1_faq_proto_goTypes = []any{
...
func file_consultingapis_faq_v1_faq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_consultingapis_faq_v1_faq_proto_rawDesc), len(file_consultingapis_faq_v1_faq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   1,
