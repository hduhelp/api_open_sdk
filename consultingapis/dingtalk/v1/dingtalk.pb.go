...
type CreateRecruitChatGroupRequest struct {
	...
	Body     *CreateRecruitChatGroupRequest_Body `protobuf:"bytes,2,opt,name=body,proto3" json:"body,omitempty"`
}
...
var file_consultingapis_dingtalk_v1_dingtalk_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x6d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08,
	0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x12, 0x52, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3e, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x74,
...
func file_consultingapis_dingtalk_v1_dingtalk_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_consultingapis_dingtalk_v1_dingtalk_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateRecruitChatGroupRequest_Body); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
