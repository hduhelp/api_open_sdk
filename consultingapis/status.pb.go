...
var file_consultingapis_status_proto_rawDesc = string([]byte{
...
var (
	...
	file_consultingapis_status_proto_rawDescData []byte
)

func file_consultingapis_status_proto_rawDescGZIP() []byte {
	file_consultingapis_status_proto_rawDescOnce.Do(func() {
		file_consultingapis_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_consultingapis_status_proto_rawDesc), len(file_consultingapis_status_proto_rawDesc)))
	})
...
func file_consultingapis_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_consultingapis_status_proto_rawDesc), len(file_consultingapis_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
