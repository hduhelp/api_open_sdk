...
func (x *GetCheckinRecordResponse) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *GetCheckinRecordResponse) GetModified() int64 {
	if x != nil {
		return x.Modified
	}
	return 0
...
func (x *GetCheckinRecordResponse) GetReportTime() int64 {
	if x != nil {
		return x.ReportTime
	}
	return 0
...
var file_campusapis_health_v1_health_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x08, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x1a, 0x0a, 0x08,
