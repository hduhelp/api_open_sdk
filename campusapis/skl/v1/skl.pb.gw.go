...
var (
	filter_SklService_GetStaffUnitInfo_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_SklService_GetStaffUnitInfo_0(ctx context.Context, marshaler runtime.Marshaler, client SklServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq StaffUnitInfoRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_SklService_GetStaffUnitInfo_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_SklService_GetStaffUnitInfo_1 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_SklService_GetStaffUnitInfo_1(ctx context.Context, marshaler runtime.Marshaler, client SklServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_SklService_GetStaffUnitInfo_1); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
// UnaryRPC     :call SklServiceServer directly.
...
func RegisterSklServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SklServiceServer) error {
	...
	mux.Handle("GET", pattern_SklService_GetStaffUnitInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_SklService_GetStaffUnitInfo_0(annotatedContext, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_SklService_GetStaffUnitInfo_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_SklService_GetStaffUnitInfo_1(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterSklServiceHandlerFromEndpoint is same as RegisterSklServiceHandler but
...
// RegisterSklServiceHandler registers the http handlers for service SklService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterSklServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterSklServiceHandlerClient(ctx, mux, NewSklServiceClient(conn))
}

// RegisterSklServiceHandlerClient registers the http handlers for service SklService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "SklServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "SklServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "SklServiceClient" to call the correct interceptors.
func RegisterSklServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SklServiceClient) error {
	...
	mux.Handle("GET", pattern_SklService_GetStaffUnitInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SklService_GetStaffUnitInfo_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_SklService_GetStaffUnitInfo_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SklService_GetStaffUnitInfo_1(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
