...
var file_campusapis_gate_v1_defined_proto_rawDesc = string([]byte{
...
var (
	...
	file_campusapis_gate_v1_defined_proto_rawDescData []byte
)

func file_campusapis_gate_v1_defined_proto_rawDescGZIP() []byte {
	file_campusapis_gate_v1_defined_proto_rawDescOnce.Do(func() {
		file_campusapis_gate_v1_defined_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_campusapis_gate_v1_defined_proto_rawDesc), len(file_campusapis_gate_v1_defined_proto_rawDesc)))
	})
...
func file_campusapis_gate_v1_defined_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_campusapis_gate_v1_defined_proto_rawDesc), len(file_campusapis_gate_v1_defined_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
