...
func (*StudentNeedyInfo_Nested) Descriptor() ([]byte, []int) {
	return file_campusapis_staff_v1_campus_proto_rawDescGZIP(), []int{9, 0}
}
...
var file_campusapis_staff_v1_campus_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x47, 0x50, 0x41, 0x22, 0xda, 0x01, 0x0a, 0x1c, 0x50, 0x6f, 0x73,
	...
	0x70, 0x68, 0x6f, 0x6e, 0x65, 0x32, 0xee, 0x11, 0x0a, 0x0d, 0x43, 0x61, 0x6d, 0x70, 0x75, 0x73,
	...
	0x65, 0x6e, 0x74, 0x2f, 0x67, 0x72, 0x61, 0x64, 0x65, 0x12, 0x80, 0x01, 0x0a, 0x15, 0x50, 0x6f,
	...
	0x12, 0x1d, 0x2f, 0x73, 0x74, 0x61, 0x66, 0x66, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x75, 0x64,
	0x65, 0x6e, 0x74, 0x2f, 0x68, 0x6f, 0x6c, 0x69, 0x64, 0x61, 0x79, 0x53, 0x74, 0x61, 0x79, 0x5a,
	...
	0x61, 0x73, 0x65, 0x5a, 0x10, 0x12, 0x0e, 0x2f, 0x66, 0x72, 0x65, 0x73, 0x68, 0x6d, 0x61, 0x6e,
	...
	0x02, 0x2b, 0x12, 0x17, 0x2f, 0x73, 0x74, 0x61, 0x66, 0x66, 0x2f, 0x76, 0x31, 0x2f, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x6d, 0x61, 0x6e, 0x2f, 0x69, 0x6e, 0x66, 0x6f, 0x5a, 0x10, 0x12, 0x0e, 0x2f,
	...
	0x93, 0x02, 0x33, 0x12, 0x1b, 0x2f, 0x73, 0x74, 0x61, 0x66, 0x66, 0x2f, 0x76, 0x31, 0x2f, 0x66,
...
var file_campusapis_staff_v1_campus_proto_goTypes = []interface{}{
	...
	(*StudentInfo)(nil),                        // 7: campusapis.staff.v1.StudentInfo
	(*GetStudentNeedyInfoResponse)(nil),        // 8: campusapis.staff.v1.GetStudentNeedyInfoResponse
	(*StudentNeedyInfo)(nil),                   // 9: campusapis.staff.v1.StudentNeedyInfo
	(*GetStudentDormInfoResponse)(nil),         // 10: campusapis.staff.v1.GetStudentDormInfoResponse
	(*DormInfo)(nil),                           // 11: campusapis.staff.v1.DormInfo
	(*GetStudentBirthdayInfoResponse)(nil),     // 12: campusapis.staff.v1.GetStudentBirthdayInfoResponse
	(*StudentBirthdayInfo)(nil),                // 13: campusapis.staff.v1.StudentBirthdayInfo
	(*GetStudentBirthdaysInRequest)(nil),       // 14: campusapis.staff.v1.GetStudentBirthdaysInRequest
	(*GetStudentBirthdaysInResponse)(nil),      // 15: campusapis.staff.v1.GetStudentBirthdaysInResponse
	(*GetStudentRewardsResponse)(nil),          // 16: campusapis.staff.v1.GetStudentRewardsResponse
	(*StudentReward)(nil),                      // 17: campusapis.staff.v1.StudentReward
	(*GetStudentCourseSelectionsResponse)(nil), // 18: campusapis.staff.v1.GetStudentCourseSelectionsResponse
	(*StudentCourseSelection)(nil),             // 19: campusapis.staff.v1.StudentCourseSelection
	(*GetStudentGradeResponse)(nil),            // 20: campusapis.staff.v1.GetStudentGradeResponse
	(*StudentGrade)(nil),                       // 21: campusapis.staff.v1.StudentGrade
	(*PostStudentGateAccessRequest)(nil),       // 22: campusapis.staff.v1.PostStudentGateAccessRequest
	(*PostStudentGateAccessResponse)(nil),      // 23: campusapis.staff.v1.PostStudentGateAccessResponse
	(*GetStudentStaySchoolInfoResponse)(nil),   // 24: campusapis.staff.v1.GetStudentStaySchoolInfoResponse
	(*StudentStaySchoolInfo)(nil),              // 25: campusapis.staff.v1.StudentStaySchoolInfo
	(*GetFreshmanBaseInfoRequest)(nil),         // 26: campusapis.staff.v1.GetFreshmanBaseInfoRequest
	(*GetFreshmanDetailRequest)(nil),           // 27: campusapis.staff.v1.GetFreshmanDetailRequest
	...
	(*GetFreshmanBaseInfoResponse)(nil),        // 30: campusapis.staff.v1.GetFreshmanBaseInfoResponse
	(*FreshmanBaseInfo)(nil),                   // 31: campusapis.staff.v1.FreshmanBaseInfo
	(*GetFreshmanDetailResponse)(nil),          // 32: campusapis.staff.v1.GetFreshmanDetailResponse
	(*FreshmanDetail)(nil),                     // 33: campusapis.staff.v1.FreshmanDetail
	(*GetFreshmanRoommatesResponse)(nil),       // 34: campusapis.staff.v1.GetFreshmanRoommatesResponse
	(*FreshmanRoommate)(nil),                   // 35: campusapis.staff.v1.FreshmanRoommate
...
var file_campusapis_staff_v1_campus_proto_depIdxs = []int32{
	...
	7,  // 1: campusapis.staff.v1.GetStudentInfoResponse.data:type_name -> campusapis.staff.v1.StudentInfo
	9,  // 2: campusapis.staff.v1.GetStudentNeedyInfoResponse.data:type_name -> campusapis.staff.v1.StudentNeedyInfo
	36, // 3: campusapis.staff.v1.StudentNeedyInfo.items:type_name -> campusapis.staff.v1.StudentNeedyInfo.Nested
	11, // 4: campusapis.staff.v1.GetStudentDormInfoResponse.data:type_name -> campusapis.staff.v1.DormInfo
	13, // 5: campusapis.staff.v1.GetStudentBirthdayInfoResponse.data:type_name -> campusapis.staff.v1.StudentBirthdayInfo
	38, // 6: campusapis.staff.v1.GetStudentBirthdaysInRequest.type:type_name -> campusapis.staff.Type
	13, // 7: campusapis.staff.v1.GetStudentBirthdaysInResponse.birthdays:type_name -> campusapis.staff.v1.StudentBirthdayInfo
	17, // 8: campusapis.staff.v1.GetStudentRewardsResponse.data:type_name -> campusapis.staff.v1.StudentReward
	19, // 9: campusapis.staff.v1.GetStudentCourseSelectionsResponse.data:type_name -> campusapis.staff.v1.StudentCourseSelection
	21, // 10: campusapis.staff.v1.GetStudentGradeResponse.data:type_name -> campusapis.staff.v1.StudentGrade
	...
	25, // 12: campusapis.staff.v1.GetStudentStaySchoolInfoResponse.data:type_name -> campusapis.staff.v1.StudentStaySchoolInfo
	31, // 13: campusapis.staff.v1.GetFreshmanBaseInfoResponse.data:type_name -> campusapis.staff.v1.FreshmanBaseInfo
	33, // 14: campusapis.staff.v1.GetFreshmanDetailResponse.data:type_name -> campusapis.staff.v1.FreshmanDetail
	35, // 15: campusapis.staff.v1.GetFreshmanRoommatesResponse.data:type_name -> campusapis.staff.v1.FreshmanRoommate
	...
	14, // 21: campusapis.staff.v1.CampusService.GetStudentBirthdaysIn:input_type -> campusapis.staff.v1.GetStudentBirthdaysInRequest
	2,  // 22: campusapis.staff.v1.CampusService.GetStudentRewards:input_type -> campusapis.staff.v1.GetStudentRewardsRequest
	3,  // 23: campusapis.staff.v1.CampusService.GetStudentCourseSelections:input_type -> campusapis.staff.v1.GetStudentCourseSelectionsRequest
	4,  // 24: campusapis.staff.v1.CampusService.GetStudentGrade:input_type -> campusapis.staff.v1.GetStudentGradeRequest
	22, // 25: campusapis.staff.v1.CampusService.PostStudentGateAccess:input_type -> campusapis.staff.v1.PostStudentGateAccessRequest
	39, // 26: campusapis.staff.v1.CampusService.GetStudentStaySchoolInfo:input_type -> google.protobuf.Empty
	26, // 27: campusapis.staff.v1.CampusService.GetFreshmanBaseInfo:input_type -> campusapis.staff.v1.GetFreshmanBaseInfoRequest
	27, // 28: campusapis.staff.v1.CampusService.GetFreshmanDetail:input_type -> campusapis.staff.v1.GetFreshmanDetailRequest
	...
	6,  // 31: campusapis.staff.v1.CampusService.GetStudentInfo:output_type -> campusapis.staff.v1.GetStudentInfoResponse
	8,  // 32: campusapis.staff.v1.CampusService.GetStudentNeedyInfo:output_type -> campusapis.staff.v1.GetStudentNeedyInfoResponse
	10, // 33: campusapis.staff.v1.CampusService.GetStudentDormInfo:output_type -> campusapis.staff.v1.GetStudentDormInfoResponse
	12, // 34: campusapis.staff.v1.CampusService.GetStudentBirthdayInfo:output_type -> campusapis.staff.v1.GetStudentBirthdayInfoResponse
	15, // 35: campusapis.staff.v1.CampusService.GetStudentBirthdaysIn:output_type -> campusapis.staff.v1.GetStudentBirthdaysInResponse
	16, // 36: campusapis.staff.v1.CampusService.GetStudentRewards:output_type -> campusapis.staff.v1.GetStudentRewardsResponse
	18, // 37: campusapis.staff.v1.CampusService.GetStudentCourseSelections:output_type -> campusapis.staff.v1.GetStudentCourseSelectionsResponse
	20, // 38: campusapis.staff.v1.CampusService.GetStudentGrade:output_type -> campusapis.staff.v1.GetStudentGradeResponse
	23, // 39: campusapis.staff.v1.CampusService.PostStudentGateAccess:output_type -> campusapis.staff.v1.PostStudentGateAccessResponse
	24, // 40: campusapis.staff.v1.CampusService.GetStudentStaySchoolInfo:output_type -> campusapis.staff.v1.GetStudentStaySchoolInfoResponse
	30, // 41: campusapis.staff.v1.CampusService.GetFreshmanBaseInfo:output_type -> campusapis.staff.v1.GetFreshmanBaseInfoResponse
	32, // 42: campusapis.staff.v1.CampusService.GetFreshmanDetail:output_type -> campusapis.staff.v1.GetFreshmanDetailResponse
	34, // 43: campusapis.staff.v1.CampusService.GetFreshmanRoommates:output_type -> campusapis.staff.v1.GetFreshmanRoommatesResponse
