...
type GetPreviousSchoolDetailInfoResponse struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	GradeSchoolInfos []*GradeSchoolInfo     `protobuf:"bytes,1,rep,name=grade_school_infos,json=gradeSchoolInfos,proto3" json:"grade_school_infos,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GetPreviousSchoolDetailInfoResponse) GetGradeSchoolInfos() []*GradeSchoolInfo {
	if x != nil {
		return x.GradeSchoolInfos
	}
	return nil
}
...
func (*StudentNeedyInfo_Nested) Descriptor() ([]byte, []int) {
	return file_campusapis_staff_v1_campus_proto_rawDescGZIP(), []int{20, 0}
}
...
func (*PostStudentGateAccessResponse_Data) Descriptor() ([]byte, []int) {
	return file_campusapis_staff_v1_campus_proto_rawDescGZIP(), []int{43, 0}
}
...
var file_campusapis_staff_v1_campus_proto_rawDesc = string([]byte{
	...
	0x52, 0x0a, 0x73, 0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x79, 0x0a, 0x23,
	...
	0x6e, 0x73, 0x65, 0x12, 0x52, 0x0a, 0x12, 0x67, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x73, 0x63, 0x68,
	0x6f, 0x6f, 0x6c, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x24, 0x2e, 0x63, 0x61, 0x6d, 0x70, 0x75, 0x73, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x73, 0x74, 0x61,
	0x66, 0x66, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x72, 0x61, 0x64, 0x65, 0x53, 0x63, 0x68, 0x6f, 0x6f,
	0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x10, 0x67, 0x72, 0x61, 0x64, 0x65, 0x53, 0x63, 0x68, 0x6f,
	0x6f, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x6d, 0x0a, 0x0f, 0x47, 0x72, 0x61, 0x64, 0x65,
	...
	0x61, 0x66, 0x66, 0x49, 0x44, 0x22, 0x5e, 0x0a, 0x22, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x66,
	0x66, 0x50, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x53, 0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x04, 0x69,
	0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x63, 0x61, 0x6d, 0x70,
	...
	0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x8f, 0x01, 0x0a, 0x0f, 0x53, 0x74, 0x61, 0x66, 0x66, 0x53,
	...
	0xfd, 0x1b, 0x0a, 0x0d, 0x43, 0x61, 0x6d, 0x70, 0x75, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x73, 0x2f, 0x73, 0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x2f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x42,
...
var file_campusapis_staff_v1_campus_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_campusapis_staff_v1_campus_proto_goTypes = []any{
	...
	(*GradeSchoolInfo)(nil),                     // 2: campusapis.staff.v1.GradeSchoolInfo
	(*GetStaffPreviousSchoolInfoRequest)(nil),   // 3: campusapis.staff.v1.GetStaffPreviousSchoolInfoRequest
	(*GetStaffPreviousSchoolInfoResponse)(nil),  // 4: campusapis.staff.v1.GetStaffPreviousSchoolInfoResponse
	(*StaffSchoolInfo)(nil),                     // 5: campusapis.staff.v1.StaffSchoolInfo
	(*GetPersonInfoResponse)(nil),               // 6: campusapis.staff.v1.GetPersonInfoResponse
	(*PersonInfo)(nil),                          // 7: campusapis.staff.v1.PersonInfo
	(*GetStudentRewardsRequest)(nil),            // 8: campusapis.staff.v1.GetStudentRewardsRequest
	(*GetStudentCourseSelectionsRequest)(nil),   // 9: campusapis.staff.v1.GetStudentCourseSelectionsRequest
	(*GetStudentGradeRequest)(nil),              // 10: campusapis.staff.v1.GetStudentGradeRequest
	(*GetGlobalStudentGradeRequest)(nil),        // 11: campusapis.staff.v1.GetGlobalStudentGradeRequest
	(*GetStudentExamRequest)(nil),               // 12: campusapis.staff.v1.GetStudentExamRequest
	(*GetDailyExamRequest)(nil),                 // 13: campusapis.staff.v1.GetDailyExamRequest
	(*SemesterRequest)(nil),                     // 14: campusapis.staff.v1.SemesterRequest
	(*GetStudentInfoResponse)(nil),              // 15: campusapis.staff.v1.GetStudentInfoResponse
	(*StudentInfo)(nil),                         // 16: campusapis.staff.v1.StudentInfo
	(*GetStudentSchoolRollStatusResponse)(nil),  // 17: campusapis.staff.v1.GetStudentSchoolRollStatusResponse
	(*StudentSchoolRollStatus)(nil),             // 18: campusapis.staff.v1.StudentSchoolRollStatus
	(*GetStudentNeedyInfoResponse)(nil),         // 19: campusapis.staff.v1.GetStudentNeedyInfoResponse
	(*StudentNeedyInfo)(nil),                    // 20: campusapis.staff.v1.StudentNeedyInfo
	(*GetStudentDormInfoResponse)(nil),          // 21: campusapis.staff.v1.GetStudentDormInfoResponse
	(*DormInfo)(nil),                            // 22: campusapis.staff.v1.DormInfo
	(*GetStudentBirthdayInfoResponse)(nil),      // 23: campusapis.staff.v1.GetStudentBirthdayInfoResponse
	(*StudentBirthdayInfo)(nil),                 // 24: campusapis.staff.v1.StudentBirthdayInfo
	(*GetStudentBirthdaysInRequest)(nil),        // 25: campusapis.staff.v1.GetStudentBirthdaysInRequest
	(*GetStudentBirthdaysInResponse)(nil),       // 26: campusapis.staff.v1.GetStudentBirthdaysInResponse
	(*GetStudentRewardsResponse)(nil),           // 27: campusapis.staff.v1.GetStudentRewardsResponse
	(*StudentReward)(nil),                       // 28: campusapis.staff.v1.StudentReward
	(*GetStudentCourseSelectionsResponse)(nil),  // 29: campusapis.staff.v1.GetStudentCourseSelectionsResponse
	(*StudentCourseSelection)(nil),              // 30: campusapis.staff.v1.StudentCourseSelection
	(*GetStudentGradeResponse)(nil),             // 31: campusapis.staff.v1.GetStudentGradeResponse
	(*StudentGrade)(nil),                        // 32: campusapis.staff.v1.StudentGrade
	(*GetGlobalStudentGradeResponse)(nil),       // 33: campusapis.staff.v1.GetGlobalStudentGradeResponse
	(*GetDailyExamResponse)(nil),                // 34: campusapis.staff.v1.GetDailyExamResponse
	(*GlobalStudentGrade)(nil),                  // 35: campusapis.staff.v1.GlobalStudentGrade
	(*GetStudentExamResponse)(nil),              // 36: campusapis.staff.v1.GetStudentExamResponse
	(*StudentExam)(nil),                         // 37: campusapis.staff.v1.StudentExam
	(*GetStudentGPAResponse)(nil),               // 38: campusapis.staff.v1.GetStudentGPAResponse
	(*StudentGPA)(nil),                          // 39: campusapis.staff.v1.StudentGPA
	(*GPAPerSemester)(nil),                      // 40: campusapis.staff.v1.GPAPerSemester
	(*GPATotal)(nil),                            // 41: campusapis.staff.v1.GPATotal
	(*PostStudentGateAccessRequest)(nil),        // 42: campusapis.staff.v1.PostStudentGateAccessRequest
	(*PostStudentGateAccessResponse)(nil),       // 43: campusapis.staff.v1.PostStudentGateAccessResponse
	(*GetStudentStaySchoolInfoResponse)(nil),    // 44: campusapis.staff.v1.GetStudentStaySchoolInfoResponse
	(*StudentStaySchoolInfo)(nil),               // 45: campusapis.staff.v1.StudentStaySchoolInfo
	(*GetFreshmanBaseInfoRequest)(nil),          // 46: campusapis.staff.v1.GetFreshmanBaseInfoRequest
	(*GetFreshmanDetailRequest)(nil),            // 47: campusapis.staff.v1.GetFreshmanDetailRequest
	(*GetFreshmanRoommatesRequest)(nil),         // 48: campusapis.staff.v1.GetFreshmanRoommatesRequest
	(*FreshmanKeywordRequest)(nil),              // 49: campusapis.staff.v1.FreshmanKeywordRequest
	(*GetFreshmanBaseInfoResponse)(nil),         // 50: campusapis.staff.v1.GetFreshmanBaseInfoResponse
	(*FreshmanBaseInfo)(nil),                    // 51: campusapis.staff.v1.FreshmanBaseInfo
	(*GetFreshmanDetailResponse)(nil),           // 52: campusapis.staff.v1.GetFreshmanDetailResponse
	(*FreshmanDetail)(nil),                      // 53: campusapis.staff.v1.FreshmanDetail
	(*GetFreshmanRoommatesResponse)(nil),        // 54: campusapis.staff.v1.GetFreshmanRoommatesResponse
	(*FreshmanRoommate)(nil),                    // 55: campusapis.staff.v1.FreshmanRoommate
	(*GetStudentCountByDivisionRequest)(nil),    // 56: campusapis.staff.v1.GetStudentCountByDivisionRequest
	(*NiceResponse)(nil),                        // 57: campusapis.staff.v1.NiceResponse
	(*StudentNeedyInfo_Nested)(nil),             // 58: campusapis.staff.v1.StudentNeedyInfo.Nested
	(*PostStudentGateAccessResponse_Data)(nil),  // 59: campusapis.staff.v1.PostStudentGateAccessResponse.Data
	(staff.Type)(0),                             // 60: campusapis.staff.Type
	(*emptypb.Empty)(nil),                       // 61: google.protobuf.Empty
}
var file_campusapis_staff_v1_campus_proto_depIdxs = []int32{
	2,  // 0: campusapis.staff.v1.GetPreviousSchoolDetailInfoResponse.grade_school_infos:type_name -> campusapis.staff.v1.GradeSchoolInfo
	5,  // 1: campusapis.staff.v1.GetStaffPreviousSchoolInfoResponse.info:type_name -> campusapis.staff.v1.StaffSchoolInfo
	7,  // 2: campusapis.staff.v1.GetPersonInfoResponse.data:type_name -> campusapis.staff.v1.PersonInfo
	16, // 3: campusapis.staff.v1.GetStudentInfoResponse.data:type_name -> campusapis.staff.v1.StudentInfo
	18, // 4: campusapis.staff.v1.GetStudentSchoolRollStatusResponse.data:type_name -> campusapis.staff.v1.StudentSchoolRollStatus
	20, // 5: campusapis.staff.v1.GetStudentNeedyInfoResponse.data:type_name -> campusapis.staff.v1.StudentNeedyInfo
	58, // 6: campusapis.staff.v1.StudentNeedyInfo.items:type_name -> campusapis.staff.v1.StudentNeedyInfo.Nested
	22, // 7: campusapis.staff.v1.GetStudentDormInfoResponse.data:type_name -> campusapis.staff.v1.DormInfo
	24, // 8: campusapis.staff.v1.GetStudentBirthdayInfoResponse.data:type_name -> campusapis.staff.v1.StudentBirthdayInfo
	60, // 9: campusapis.staff.v1.GetStudentBirthdaysInRequest.type:type_name -> campusapis.staff.Type
	24, // 10: campusapis.staff.v1.GetStudentBirthdaysInResponse.data:type_name -> campusapis.staff.v1.StudentBirthdayInfo
	28, // 11: campusapis.staff.v1.GetStudentRewardsResponse.data:type_name -> campusapis.staff.v1.StudentReward
	30, // 12: campusapis.staff.v1.GetStudentCourseSelectionsResponse.data:type_name -> campusapis.staff.v1.StudentCourseSelection
	32, // 13: campusapis.staff.v1.GetStudentGradeResponse.data:type_name -> campusapis.staff.v1.StudentGrade
	35, // 14: campusapis.staff.v1.GetGlobalStudentGradeResponse.data:type_name -> campusapis.staff.v1.GlobalStudentGrade
	37, // 15: campusapis.staff.v1.GetDailyExamResponse.data:type_name -> campusapis.staff.v1.StudentExam
	37, // 16: campusapis.staff.v1.GetStudentExamResponse.data:type_name -> campusapis.staff.v1.StudentExam
	39, // 17: campusapis.staff.v1.GetStudentGPAResponse.data:type_name -> campusapis.staff.v1.StudentGPA
	40, // 18: campusapis.staff.v1.StudentGPA.perSemester:type_name -> campusapis.staff.v1.GPAPerSemester
	41, // 19: campusapis.staff.v1.StudentGPA.total:type_name -> campusapis.staff.v1.GPATotal
	59, // 20: campusapis.staff.v1.PostStudentGateAccessResponse.data:type_name -> campusapis.staff.v1.PostStudentGateAccessResponse.Data
	45, // 21: campusapis.staff.v1.GetStudentStaySchoolInfoResponse.data:type_name -> campusapis.staff.v1.StudentStaySchoolInfo
	51, // 22: campusapis.staff.v1.GetFreshmanBaseInfoResponse.data:type_name -> campusapis.staff.v1.FreshmanBaseInfo
	53, // 23: campusapis.staff.v1.GetFreshmanDetailResponse.data:type_name -> campusapis.staff.v1.FreshmanDetail
	55, // 24: campusapis.staff.v1.GetFreshmanRoommatesResponse.data:type_name -> campusapis.staff.v1.FreshmanRoommate
	61, // 25: campusapis.staff.v1.CampusService.GetPersonInfo:input_type -> google.protobuf.Empty
	61, // 26: campusapis.staff.v1.CampusService.GetStudentInfo:input_type -> google.protobuf.Empty
	56, // 27: campusapis.staff.v1.CampusService.GetStudentCountByDivision:input_type -> campusapis.staff.v1.GetStudentCountByDivisionRequest
	61, // 28: campusapis.staff.v1.CampusService.GetStudentSchoolRollStatus:input_type -> google.protobuf.Empty
	61, // 29: campusapis.staff.v1.CampusService.GetStudentDormInfo:input_type -> google.protobuf.Empty
	61, // 30: campusapis.staff.v1.CampusService.GetStudentBirthdayInfo:input_type -> google.protobuf.Empty
	25, // 31: campusapis.staff.v1.CampusService.GetStudentBirthdaysIn:input_type -> campusapis.staff.v1.GetStudentBirthdaysInRequest
	8,  // 32: campusapis.staff.v1.CampusService.GetStudentRewards:input_type -> campusapis.staff.v1.GetStudentRewardsRequest
	9,  // 33: campusapis.staff.v1.CampusService.GetStudentCourseSelections:input_type -> campusapis.staff.v1.GetStudentCourseSelectionsRequest
	10, // 34: campusapis.staff.v1.CampusService.GetStudentGrade:input_type -> campusapis.staff.v1.GetStudentGradeRequest
	11, // 35: campusapis.staff.v1.CampusService.GetGlobalStudentGrade:input_type -> campusapis.staff.v1.GetGlobalStudentGradeRequest
	12, // 36: campusapis.staff.v1.CampusService.GetStudentExam:input_type -> campusapis.staff.v1.GetStudentExamRequest
	13, // 37: campusapis.staff.v1.CampusService.GetDailyExam:input_type -> campusapis.staff.v1.GetDailyExamRequest
	61, // 38: campusapis.staff.v1.CampusService.GetStudentGPA:input_type -> google.protobuf.Empty
	42, // 39: campusapis.staff.v1.CampusService.PostStudentGateAccess:input_type -> campusapis.staff.v1.PostStudentGateAccessRequest
	61, // 40: campusapis.staff.v1.CampusService.GetStudentStaySchoolInfo:input_type -> google.protobuf.Empty
	46, // 41: campusapis.staff.v1.CampusService.GetFreshmanBaseInfo:input_type -> campusapis.staff.v1.GetFreshmanBaseInfoRequest
	47, // 42: campusapis.staff.v1.CampusService.GetFreshmanDetail:input_type -> campusapis.staff.v1.GetFreshmanDetailRequest
	48, // 43: campusapis.staff.v1.CampusService.GetFreshmanRoommates:input_type -> campusapis.staff.v1.GetFreshmanRoommatesRequest
	3,  // 44: campusapis.staff.v1.CampusService.GetPreviousSchoolInfo:input_type -> campusapis.staff.v1.GetStaffPreviousSchoolInfoRequest
	0,  // 45: campusapis.staff.v1.CampusService.GetPreviousSchoolDetailInfo:input_type -> campusapis.staff.v1.GetPreviousSchoolDetailInfoRequest
	6,  // 46: campusapis.staff.v1.CampusService.GetPersonInfo:output_type -> campusapis.staff.v1.GetPersonInfoResponse
	15, // 47: campusapis.staff.v1.CampusService.GetStudentInfo:output_type -> campusapis.staff.v1.GetStudentInfoResponse
	57, // 48: campusapis.staff.v1.CampusService.GetStudentCountByDivision:output_type -> campusapis.staff.v1.NiceResponse
	17, // 49: campusapis.staff.v1.CampusService.GetStudentSchoolRollStatus:output_type -> campusapis.staff.v1.GetStudentSchoolRollStatusResponse
	21, // 50: campusapis.staff.v1.CampusService.GetStudentDormInfo:output_type -> campusapis.staff.v1.GetStudentDormInfoResponse
	23, // 51: campusapis.staff.v1.CampusService.GetStudentBirthdayInfo:output_type -> campusapis.staff.v1.GetStudentBirthdayInfoResponse
	26, // 52: campusapis.staff.v1.CampusService.GetStudentBirthdaysIn:output_type -> campusapis.staff.v1.GetStudentBirthdaysInResponse
	27, // 53: campusapis.staff.v1.CampusService.GetStudentRewards:output_type -> campusapis.staff.v1.GetStudentRewardsResponse
	29, // 54: campusapis.staff.v1.CampusService.GetStudentCourseSelections:output_type -> campusapis.staff.v1.GetStudentCourseSelectionsResponse
	31, // 55: campusapis.staff.v1.CampusService.GetStudentGrade:output_type -> campusapis.staff.v1.GetStudentGradeResponse
	33, // 56: campusapis.staff.v1.CampusService.GetGlobalStudentGrade:output_type -> campusapis.staff.v1.GetGlobalStudentGradeResponse
	36, // 57: campusapis.staff.v1.CampusService.GetStudentExam:output_type -> campusapis.staff.v1.GetStudentExamResponse
	34, // 58: campusapis.staff.v1.CampusService.GetDailyExam:output_type -> campusapis.staff.v1.GetDailyExamResponse
	38, // 59: campusapis.staff.v1.CampusService.GetStudentGPA:output_type -> campusapis.staff.v1.GetStudentGPAResponse
	43, // 60: campusapis.staff.v1.CampusService.PostStudentGateAccess:output_type -> campusapis.staff.v1.PostStudentGateAccessResponse
	44, // 61: campusapis.staff.v1.CampusService.GetStudentStaySchoolInfo:output_type -> campusapis.staff.v1.GetStudentStaySchoolInfoResponse
	50, // 62: campusapis.staff.v1.CampusService.GetFreshmanBaseInfo:output_type -> campusapis.staff.v1.GetFreshmanBaseInfoResponse
	52, // 63: campusapis.staff.v1.CampusService.GetFreshmanDetail:output_type -> campusapis.staff.v1.GetFreshmanDetailResponse
	54, // 64: campusapis.staff.v1.CampusService.GetFreshmanRoommates:output_type -> campusapis.staff.v1.GetFreshmanRoommatesResponse
	4,  // 65: campusapis.staff.v1.CampusService.GetPreviousSchoolInfo:output_type -> campusapis.staff.v1.GetStaffPreviousSchoolInfoResponse
	1,  // 66: campusapis.staff.v1.CampusService.GetPreviousSchoolDetailInfo:output_type -> campusapis.staff.v1.GetPreviousSchoolDetailInfoResponse
