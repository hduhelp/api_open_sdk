...
type GetFreshmanBaseInfoResponse struct {
	...
	StaffName string `protobuf:"bytes,2,opt,name=staffName,proto3" json:"staffName,omitempty"` //姓名
	OfferId   string `protobuf:"bytes,3,opt,name=offerId,proto3" json:"offerId,omitempty"`     //录取通知书号或者是准考证号，不同身份并不一样
	IdCardNo  string `protobuf:"bytes,4,opt,name=idCardNo,proto3" json:"idCardNo,omitempty"`   //身份证号
	OfferTime string `protobuf:"bytes,5,opt,name=offerTime,proto3" json:"offerTime,omitempty"` //录取时间
...
type GetFreshmanInfoResponse struct {
	...
	HasPaid        string `protobuf:"bytes,14,opt,name=hasPaid,proto3" json:"hasPaid,omitempty"` //是否支付学费
	LSTD           string `protobuf:"bytes,15,opt,name=LSTD,proto3" json:"LSTD,omitempty"`       //绿色通道
...
type GetFreshmanRoommatesResponse_Roommate struct {
	...
	StaffName string `protobuf:"bytes,1,opt,name=staffName,proto3" json:"staffName,omitempty"` //室友姓名
...
var file_campusapis_staff_v1_freshman_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x32, 0x91, 0x04, 0x0a, 0x0f, 0x46, 0x72, 0x65, 0x73, 0x68,
	...
	0x6e, 0x2f, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0xb1, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x46, 0x72,
	...
	0x73, 0x74, 0x61, 0x66, 0x66, 0x2f, 0x76, 0x31, 0x2f, 0x66, 0x72, 0x65, 0x73, 0x68, 0x6d, 0x61,
	0x6e, 0x2f, 0x72, 0x6f, 0x6f, 0x6d, 0x6d, 0x61, 0x74, 0x65, 0x42, 0xd3, 0x01, 0x0a, 0x17, 0x63,
	0x6f, 0x6d, 0x2e, 0x63, 0x61, 0x6d, 0x70, 0x75, 0x73, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x73, 0x74,
	0x61, 0x66, 0x66, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x46, 0x72, 0x65, 0x73, 0x68, 0x6d, 0x61, 0x6e,
