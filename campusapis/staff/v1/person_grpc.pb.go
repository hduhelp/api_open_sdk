...
func (c *personServiceClient) GetPersonInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetPersonInfoResponse, error) {
	out := new(GetPersonInfoResponse)
	err := c.cc.Invoke(ctx, "/campusapis.staff.v1.PersonService/GetPersonInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPersonServiceServer) GetPersonInfo(context.Context, *emptypb.Empty) (*GetPersonInfoResponse, error) {
...
func _PersonService_GetPersonInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/campusapis.staff.v1.PersonService/GetPersonInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).GetPersonInfo(ctx, req.(*emptypb.Empty))
	}
...
var PersonService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "campusapis.staff.v1.PersonService",
	...
	Metadata: "campusapis/staff/v1/person.proto",
}
