...
func (x *GetScheduleRequest) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *GetScheduleResponse_Course_Schedule) GetStartTime() int64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *GetScheduleResponse_Course_Schedule) GetEndTime() int64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
var file_campusapis_teaching_v1_teaching_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x07, 0x45, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x32, 0x0a, 0x08, 0x54, 0x65,
