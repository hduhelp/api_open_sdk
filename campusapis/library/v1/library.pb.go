...
const (
	//未知
	LendStatus_UNKNOWN LendStatus = 0
	//借阅中
	LendStatus_LENDING LendStatus = 1
	//已归还
	LendStatus_RETURNED LendStatus = 2
)
...
func (x *GetBookInfoResponse) GetBook() *BookInfo {
	if x != nil {
		return x.Book
	}
	return nil
...
type BookInfo struct {
	...
	//年累计借阅次数
	YearCircTimes uint32 `protobuf:"varint,9,opt,name=yearCircTimes,proto3" json:"yearCircTimes,omitempty"`
	//总累计借阅次数
	TotalCircTimes uint32 `protobuf:"varint,10,opt,name=totalCircTimes,proto3" json:"totalCircTimes,omitempty"`
	//首次借阅时间
	FirstUseDate uint32 `protobuf:"varint,11,opt,name=firstUseDate,proto3" json:"firstUseDate,omitempty"`
	//最后借阅时间
	LastUseDate uint32 `protobuf:"varint,12,opt,name=lastUseDate,proto3" json:"lastUseDate,omitempty"`
	//记录标志更新时间
	RecFlagUptDate uint32 `protobuf:"varint,13,opt,name=recFlagUptDate,proto3" json:"recFlagUptDate,omitempty"`
	//登记日期
	RegDay uint32 `protobuf:"varint,14,opt,name=regDay,proto3" json:"regDay,omitempty"`
	//馆藏地
...
func (x *BookInfo) GetYearCircTimes() uint32 {
	if x != nil {
...
func (x *BookInfo) GetTotalCircTimes() uint32 {
	if x != nil {
...
func (x *BookInfo) GetFirstUseDate() uint32 {
	if x != nil {
...
func (x *BookInfo) GetLastUseDate() uint32 {
	if x != nil {
...
func (x *BookInfo) GetRecFlagUptDate() uint32 {
	if x != nil {
...
func (x *BookInfo) GetRegDay() uint32 {
	if x != nil {
		return x.RegDay
	}
	return 0
...
func (x *GetBookInfoListResponse) GetBooks() []*BookInfo {
	if x != nil {
		return x.Books
	}
	return nil
...
func (x *GetBookMARCResponse) GetMarc() *BookMARC {
	if x != nil {
		return x.Marc
	}
	return nil
...
func (x *GetBookMARCListRequest) GetLimit() uint32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *GetBookMARCListRequest) GetOffset() uint32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
type GetBookMARCListResponse struct {
	...
	Marcs []*BookMARC `protobuf:"bytes,1,rep,name=marcs,proto3" json:"marcs,omitempty"`
}
...
func (x *GetBookMARCListResponse) GetMarcs() []*BookMARC {
	if x != nil {
		return x.Marcs
	}
	return nil
...
type GetLendLastRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetLendLastRequest) Reset() {
	*x = GetLendLastRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLendLastRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLendLastRequest) ProtoMessage() {}

func (x *GetLendLastRequest) ProtoReflect() protoreflect.Message {
	mi := &file_campusapis_library_v1_library_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLendLastRequest.ProtoReflect.Descriptor instead.
func (*GetLendLastRequest) Descriptor() ([]byte, []int) {
	return file_campusapis_library_v1_library_proto_rawDescGZIP(), []int{10}
}

func (x *GetLendLastRequest) GetStartTime() uint32 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
type GetLendHistoryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetLendHistoryRequest) Reset() {
	*x = GetLendHistoryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLendHistoryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLendHistoryRequest) ProtoMessage() {}

func (x *GetLendHistoryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_campusapis_library_v1_library_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLendHistoryRequest.ProtoReflect.Descriptor instead.
func (*GetLendHistoryRequest) Descriptor() ([]byte, []int) {
	return file_campusapis_library_v1_library_proto_rawDescGZIP(), []int{11}
}

func (x *GetLendHistoryRequest) GetStartTime() uint32 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *GetLendHistoryRequest) GetEndTime() uint32 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
type GetBookLendLastResponse struct {
	...
	Items []*GetBookLendLastResponse_Nested `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
}
...
func (x *GetBookLendLastResponse) GetItems() []*GetBookLendLastResponse_Nested {
	if x != nil {
		return x.Items
	}
	return nil
...
type GetBookLendHistoryResponse struct {
	...
	Items []*GetBookLendHistoryResponse_Nested `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
}
...
func (x *GetBookLendHistoryResponse) GetItems() []*GetBookLendHistoryResponse_Nested {
	if x != nil {
		return x.Items
	}
	return nil
...
type GetBookLendLastResponse_Nested struct {
	...
	LendDate         uint32     `protobuf:"varint,3,opt,name=lendDate,proto3" json:"lendDate,omitempty"`
	NormalReturnDate uint32     `protobuf:"varint,4,opt,name=normalReturnDate,proto3" json:"normalReturnDate,omitempty"`
	RenewDate        uint32     `protobuf:"varint,5,opt,name=renewDate,proto3" json:"renewDate,omitempty"`
	RenewTimes       uint32     `protobuf:"varint,6,opt,name=renewTimes,proto3" json:"renewTimes,omitempty"`
...
func (x *GetBookLendLastResponse_Nested) GetLendDate() uint32 {
	if x != nil {
		return x.LendDate
	}
	return 0
...
func (x *GetBookLendLastResponse_Nested) GetNormalReturnDate() uint32 {
	if x != nil {
...
func (x *GetBookLendLastResponse_Nested) GetRenewDate() uint32 {
	if x != nil {
		return x.RenewDate
	}
	return 0
...
func (x *GetBookLendLastResponse_Nested) GetRenewTimes() uint32 {
	if x != nil {
		return x.RenewTimes
	}
	return 0
...
type GetBookLendHistoryResponse_Nested struct {
	...
	StaffID    string     `protobuf:"bytes,2,opt,name=staffID,proto3" json:"staffID,omitempty"`
	LendDate   uint32     `protobuf:"varint,3,opt,name=lendDate,proto3" json:"lendDate,omitempty"`
	ReturnDate uint32     `protobuf:"varint,4,opt,name=returnDate,proto3" json:"returnDate,omitempty"`
	RenewDate  uint32     `protobuf:"varint,5,opt,name=renewDate,proto3" json:"renewDate,omitempty"`
	RenewTimes uint32     `protobuf:"varint,6,opt,name=renewTimes,proto3" json:"renewTimes,omitempty"`
	Location   string     `protobuf:"bytes,7,opt,name=location,proto3" json:"location,omitempty"`
	Status     LendStatus `protobuf:"varint,8,opt,name=status,proto3,enum=campusapis.library.v1.LendStatus" json:"status,omitempty"`
...
func (x *GetBookLendHistoryResponse_Nested) GetLendDate() uint32 {
	if x != nil {
		return x.LendDate
	}
	return 0
...
func (x *GetBookLendHistoryResponse_Nested) GetReturnDate() uint32 {
	if x != nil {
		return x.ReturnDate
	}
	return 0
...
func (x *GetBookLendHistoryResponse_Nested) GetRenewDate() uint32 {
	if x != nil {
		return x.RenewDate
	}
	return 0
...
func (x *GetBookLendHistoryResponse_Nested) GetRenewTimes() uint32 {
	if x != nil {
		return x.RenewTimes
	}
	return 0
...
var file_campusapis_library_v1_library_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x1a, 0x1f, 0x67, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x64, 0x6f, 0x63, 0x54, 0x79, 0x70, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x64, 0x6f, 0x63, 0x54, 0x79, 0x70, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x16,
	0x0a, 0x06, 0x63, 0x61, 0x6c, 0x6c, 0x4e, 0x6f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x63, 0x61, 0x6c, 0x6c, 0x4e, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18,
	...
	,
	...
	0x28, 0x0d, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x50, 0x0a, 0x17, 0x47, 0x65,
	0x74, 0x42, 0x6f, 0x6f, 0x6b, 0x4d, 0x41, 0x52, 0x43, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x05, 0x6d, 0x61, 0x72, 0x63, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x61, 0x6d, 0x70, 0x75, 0x73, 0x61, 0x70, 0x69,
	0x73, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x6f, 0x6f,
	0x6b, 0x4d, 0x41, 0x52, 0x43, 0x52, 0x05, 0x6d, 0x61, 0x72, 0x63, 0x73, 0x22, 0x32, 0x0a, 0x12,
	0x47, 0x65, 0x74, 0x4c, 0x65, 0x6e, 0x64, 0x4c, 0x61, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x22, 0x4f, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4c, 0x65, 0x6e, 0x64, 0x48, 0x69, 0x73, 0x74, 0x6f,
	0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x73, 0x74,
	...
	0x65, 0x22, 0x9d, 0x03, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x42, 0x6f, 0x6f, 0x6b, 0x4c, 0x65, 0x6e,
	0x64, 0x4c, 0x61, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4b, 0x0a,
	...
	0x79, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x42, 0x6f, 0x6f, 0x6b, 0x4c, 0x65, 0x6e, 0x64,
	0x4c, 0x61, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x4e, 0x65, 0x73,
	0x74, 0x65, 0x64, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0xb4, 0x02, 0x0a, 0x06, 0x4e,
	0x65, 0x73, 0x74, 0x65, 0x64, 0x12, 0x33, 0x0a, 0x04, 0x62, 0x6f, 0x6f, 0x6b, 0x18, 0x01, 0x20,
	...
	,
	...
	0x38, 0x2e, 0x63, 0x61, 0x6d, 0x70, 0x75, 0x73, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x6c, 0x69, 0x62,
	0x72, 0x61, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x42, 0x6f, 0x6f, 0x6b, 0x4c,
	...
	0x1a, 0xa8, 0x02, 0x0a, 0x06, 0x4e, 0x65, 0x73, 0x74, 0x65, 0x64, 0x12, 0x33, 0x0a, 0x04, 0x62,
	0x6f, 0x6f, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x61, 0x6d, 0x70,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_campusapis_library_v1_library_proto_goTypes = []interface{}{
	...
	(*GetLendLastRequest)(nil),                // 11: campusapis.library.v1.GetLendLastRequest
	(*GetLendHistoryRequest)(nil),             // 12: campusapis.library.v1.GetLendHistoryRequest
...
var file_campusapis_library_v1_library_proto_depIdxs = []int32{
	3,  // 0: campusapis.library.v1.GetBookInfoResponse.book:type_name -> campusapis.library.v1.BookInfo
	8,  // 1: campusapis.library.v1.BookInfo.marc:type_name -> campusapis.library.v1.BookMARC
	3,  // 2: campusapis.library.v1.GetBookInfoListResponse.books:type_name -> campusapis.library.v1.BookInfo
	8,  // 3: campusapis.library.v1.GetBookMARCResponse.marc:type_name -> campusapis.library.v1.BookMARC
	8,  // 4: campusapis.library.v1.GetBookMARCListRequest.marc:type_name -> campusapis.library.v1.BookMARC
	8,  // 5: campusapis.library.v1.GetBookMARCListResponse.marcs:type_name -> campusapis.library.v1.BookMARC
	15, // 6: campusapis.library.v1.GetBookLendLastResponse.items:type_name -> campusapis.library.v1.GetBookLendLastResponse.Nested
	16, // 7: campusapis.library.v1.GetBookLendHistoryResponse.items:type_name -> campusapis.library.v1.GetBookLendHistoryResponse.Nested
	...
	11, // 16: campusapis.library.v1.LibraryService.GetBookLendLast:input_type -> campusapis.library.v1.GetLendLastRequest
	12, // 17: campusapis.library.v1.LibraryService.GetBookLendHistory:input_type -> campusapis.library.v1.GetLendHistoryRequest
...
func file_campusapis_library_v1_library_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_campusapis_library_v1_library_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLendLastRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_campusapis_library_v1_library_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLendHistoryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
