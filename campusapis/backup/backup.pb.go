...
var file_campusapis_backup_backup_proto_rawDesc = string([]byte{
...
func file_campusapis_backup_backup_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_campusapis_backup_backup_proto_rawDesc), len(file_campusapis_backup_backup_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
