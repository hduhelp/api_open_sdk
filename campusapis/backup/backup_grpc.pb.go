...
func (c *campusBackupServiceClient) GetPersonInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.GetPersonInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, CampusBackupService_GetPersonInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campusBackupServiceClient) GetStudentInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.GetStudentInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, CampusBackupService_GetStudentInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campusBackupServiceClient) GetStudentGrade(ctx context.Context, in *v1.GetStudentGradeRequest, opts ...grpc.CallOption) (*v1.GetStudentGradeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CampusBackupService_GetStudentGrade_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campusBackupServiceClient) GetStudentExam(ctx context.Context, in *v1.GetStudentExamRequest, opts ...grpc.CallOption) (*v1.GetStudentExamResponse, error) {
	...
	err := c.cc.Invoke(ctx, CampusBackupService_GetStudentExam_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campusBackupServiceClient) GetScheduleNowV2(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v11.GetScheduleNowV2Response, error) {
	...
	err := c.cc.Invoke(ctx, CampusBackupService_GetScheduleNowV2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCampusBackupServiceServer must be embedded to have
...
func (UnimplementedCampusBackupServiceServer) testEmbeddedByValue()                             {}
...
func RegisterCampusBackupServiceServer(s grpc.ServiceRegistrar, srv CampusBackupServiceServer) {
	// If the following call pancis, it indicates UnimplementedCampusBackupServiceServer was
