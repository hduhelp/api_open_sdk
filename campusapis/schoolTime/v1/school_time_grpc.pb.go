...
func (c *schoolTimeServiceClient) GetSchoolTime(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetSchoolTimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, SchoolTimeService_GetSchoolTime_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schoolTimeServiceClient) GetSemesterList(ctx context.Context, in *GetSemesterListRequest, opts ...grpc.CallOption) (*GetSemesterListResponse, error) {
	...
	err := c.cc.Invoke(ctx, SchoolTimeService_GetSemesterList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSchoolTimeServiceServer must be embedded to have
...
func (UnimplementedSchoolTimeServiceServer) testEmbeddedByValue()                           {}
...
func RegisterSchoolTimeServiceServer(s grpc.ServiceRegistrar, srv SchoolTimeServiceServer) {
	// If the following call pancis, it indicates UnimplementedSchoolTimeServiceServer was
