...
var file_campusapis_schoolTime_v1_school_time_proto_rawDesc = string([]byte{
...
var (
	...
	file_campusapis_schoolTime_v1_school_time_proto_rawDescData []byte
)
...
func file_campusapis_schoolTime_v1_school_time_proto_rawDescGZIP() []byte {
	file_campusapis_schoolTime_v1_school_time_proto_rawDescOnce.Do(func() {
		file_campusapis_schoolTime_v1_school_time_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_campusapis_schoolTime_v1_school_time_proto_rawDesc), len(file_campusapis_schoolTime_v1_school_time_proto_rawDesc)))
	})
...
func file_campusapis_schoolTime_v1_school_time_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_campusapis_schoolTime_v1_school_time_proto_rawDesc), len(file_campusapis_schoolTime_v1_school_time_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
