...
func RegisterTimeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TimeServiceServer) error {
	...
	mux.Handle("GET", pattern_TimeService_GetTime_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_TimeService_GetTime_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_TimeService_GetTime_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTimeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TimeServiceClient) error {
	...
	mux.Handle("GET", pattern_TimeService_GetTime_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_TimeService_GetTime_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_TimeService_GetTime_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"time", "v1"}, ""))
)

var (
	forward_TimeService_GetTime_0 = runtime.ForwardResponseMessage
)
